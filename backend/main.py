...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        if db.session.query(_CaseModel).count() < 10:
            import random as _rd
            now = datetime.utcnow()
            session_id = f'auto_seed_{now.strftime("%Y%m%d_%H%M%S")}'
            
            # 先创建 AnalysisSession 记录
            if not db.session.query(AnalysisSession).filter_by(session_id=session_id).first():
            ...
            _seed_cases = [
                ...
                {"title":"京东白条利率调整诈骗","victim":"张丽","amount":234000,"type":"冒充客服","desc":"对方自称京东客服，称白条利率高于国家规定需调整。诱导下载腾讯会议开启屏幕共享，指导其在各网贷平台借款后转账。"},
                {"title":"冒充公检法洗钱案","victim":"周秀英","amount":458000,"type":"冒充公检法","desc":"接到自称某市公安局电话，称其涉嫌洗钱犯罪。要求配合调查并通过资金审查证明清白，将所有资金转入安全账户。"},
                {"title":"冒充检察院案件核查","victim":"吴建国","amount":289000,"type":"冒充公检法","desc":"骗子冒充检察院工作人员，称其涉及一起重大经济案件。通过伪造的通缉令和冻结令恐吓受害人，诱导其转账。"},
                {"title":"刷单返利连环诈骗案","victim":"何小燕","amount":87600,"type":"刷单返利","desc":"在微信群看到刷单兼职广告，添加客服后开始做任务。前几单小额返利成功后，被诱导做大额任务，后无法提现。"},
                {"title":"抖音点赞刷单诈骗","victim":"宋玉华","amount":34500,"type":"刷单返利","desc":"在抖音上看到点赞赚钱广告，下载指定APP后开始做任务。前期获得小额返利，后期被要求预付垫资后无法提现。"},
                ...
                {"title":"冒充领导借款诈骗","victim":"杨国平","amount":280000,"type":"冒充熟人","desc":"接到冒充乡镇领导的微信好友申请，对方以需要转账但不方便操作为由，要求代转账。"},
                {"title":"冒充子女要学费诈骗","victim":"王秀华","amount":45600,"type":"冒充熟人","desc":"接到冒充在外地上大学的孩子的电话，称学校需要缴纳培训费。因声音相似未怀疑，转账后联系孩子才发现被骗。"},
                {"title":"冒充天猫客服退款诈骗","victim":"林志强","amount":82300,"type":"冒充客服","desc":"接到冒充天猫客服电话，称其购买的商品存在质量问题可双倍退款。诱导添加QQ好友后发送钓鱼链接，填写银行卡信息后被转走余额。"},
                {"title":"冒充快递客服理赔诈骗","victim":"邓丽娟","amount":45600,"type":"冒充客服","desc":"接到自称中通快递客服电话，称其快递丢失可理赔198元。要求下载佳信通APP并开启屏幕共享，指导在支付宝备用金操作。"},
                {"title":"冒充银行客服调额诈骗","victim":"郑建军","amount":128000,"type":"冒充客服","desc":"接到冒充招商银行客服电话，称可提升信用卡额度至10万。要求提供短信验证码和CVV码，随后信用卡被盗刷。"},
                ...
                {"title":"刷单做任务连环诈骗","victim":"邱文强","amount":345000,"type":"刷单返利","desc":"在58同城看到高薪兼职信息，添加对方QQ后开始刷单。被诱导连做三单大额任务，每单垫付5-10万，完成后被告知系统冻结需继续充值解决。"},
                ...
                {"title":"黄金投资诈骗","victim":"龙文强","amount":456000,"type":"投资理财","desc":"通过婚恋平台认识自称从事黄金交易的女友，推荐下载鑫镒国际APP炒黄金。前期小额盈利可提现，后投入45.6万时平台显示爆仓无法操作。"},
                {"title":"冒充亲戚借钱诈骗","victim":"蔡丽娟","amount":125000,"type":"冒充熟人","desc":"接到冒充在外地做生意的侄子的电话，称急需一笔货款周转。因声音相似未起疑心，通过银行柜台转账到指定账户，后联系真侄子发现被骗。"},
                {"title":"冒充朋友急事诈骗","victim":"丁建军","amount":67800,"type":"冒充熟人","desc":"收到冒充好友的微博私信，称在国外手机丢失无法使用银行卡，请求帮忙购买机票。转账到提供的账户后，联系好友本人发现账号被盗。"},
                {"title":"网贷保证金诈骗","victim":"沈玉华","amount":25600,"type":"网络贷款","desc":"在网上搜索贷款信息后接到冒充贷款平台客服电话，称可提供30万无抵押贷款。要求先缴纳5%的保证金验证还款能力，转账后对方称流水不足需继续缴费。"},
                {"title":"网贷解冻费诈骗","victim":"黎志强","amount":48900,"type":"网络贷款","desc":"下载速易贷APP申请贷款5万元，平台显示放款成功但银行卡号填写错误导致冻结。客服要求缴纳解冻费和解绑费，多次转账后平台无法打开。"},
                {"title":"冒充公安协查诈骗","victim":"傅晓峰","amount":389000,"type":"冒充公检法","desc":"接到冒充武汉市刑侦支队电话，称其身份证被用于洗钱案。要求添加QQ视频做笔录，展示伪造的通缉令和警官证，恐吓后要求转账到安全账户。"},
                ...
                {"title":"快手点赞刷单诈骗","victim":"范晓东","amount":56700,"type":"刷单返利","desc":"在快手看到点赞赚钱广告，添加对方微信后被拉入任务群。前5单每单返利5元，后要求下载创鑫APP做联单任务，充值后无法提现。"},
                {"title":"公众号关注刷单诈骗","victim":"廖雪梅","amount":78900,"type":"刷单返利","desc":"在短信中看到关注公众号赚钱信息，添加客服后开始关注任务。前期获得返利9元，后被诱导做垫付任务，转账后客服失联。"},
                ...
                {"title":"股票投资杀猪盘诈骗","victim":"邹建军","amount":912000,"type":"投资理财","desc":"被拉入股票交流群，群内有百余人。群主推荐某涨停板股票并要求统一在指定平台买入。大量资金入市后股票暴跌，平台关闭群聊解散。"},
                ...
                {"title":"网贷刷流水诈骗","victim":"冯晓燕","amount":72300,"type":"网络贷款","desc":"接到贷款推销电话称可办理30万大额贷款，要求提供银行卡户流水提高贷款额度。按对方指示向多个账户转账后，对方电话关机。"},
                {"title":"网贷提额诈骗","victim":"韩建军","amount":34500,"type":"网络贷款","desc":"收到冒充正规贷款平台的短信称可提升额度至50万，点击链接进入假冒平台。填写资料后被告知需缴纳手续费和提额服务费，转账后平台无法访问。"},
                ...
                {"title":"冒充金融客服注销贷款","victim":"赵敏","amount":312000,"type":"冒充客服","desc":"对方自称京东金融客服，称其名下有多笔贷款需要注销。要求将资金转入指定账户进行流水验证，先后转账3笔。"},
                {"title":"刷单返利APP诈骗","victim":"金志明","amount":167800,"type":"刷单返利","desc":"通过陌生好友邀请下载淘客联单APP，平台客服引导做刷单任务。前期成功提现500元，后做大额任务时提示操作失误需补单，多次转账后平台关闭。"},
                {"title":"刷单平台充值诈骗","victim":"龚小燕","amount":289000,"type":"刷单返利","desc":"被网友推荐下载星耀刷单平台，称充值越多返利越高。首次充值5000元返利500元并成功提现，随后充值10万元发现平台无法登录。"},
                {"title":"数字藏品投资诈骗","victim":"罗志远","amount":234000,"type":"投资理财","desc":"在社群中看到数字藏品投资机会，平台宣称每件藏品限量发行且可增值百倍。购买多件藏品后平台推出二级交易市场，挂单出售后资金无法提现。"},
                ...
                {"title":"冒充同学借钱诈骗","victim":"程小燕","amount":34500,"type":"冒充熟人","desc":"收到冒充初中同学的微信好友申请，通过后对方称家人病急需用钱。视频通话仅3秒后挂断称信号不好，要求转账到银行卡，转账后对方失联。"},
                {"title":"冒充公安断卡行动诈骗","victim":"谭志强","amount":167000,"type":"冒充公检法","desc":"接到冒充深圳市公安局电话，称其银行卡涉嫌参与电信诈骗洗钱。要求下载安全防护APP并开启远程控制，手机被操控转走资金。"},
                {"title":"冒充网警反诈诈骗","victim":"崔丽娟","amount":89400,"type":"冒充公检法","desc":"在网络上搜索反诈咨询电话，找到冒充网警的联系方式。对方称其账户有风险需将资金转入警方安全账户保管，转账后被拉黑。"},
                {"title":"冒充电信客服升级套餐诈骗","victim":"唐玉华","amount":28600,"type":"冒充客服","desc":"接到冒充中国电信客服电话，称可以免费升级5G套餐并赠送礼品。要求提供身份证号和银行卡号进行登记，随后发现银行卡被盗刷。"},
                {"title":"冒充支付宝客服修改信息诈骗","victim":"宋国平","amount":94500,"type":"冒充客服","desc":"接到自称支付宝客服电话，称其个人信息过期需更新否则账户冻结。引导登录钓鱼网站填写支付宝账号密码和支付密码，账户内余额被转走。"},
                {"title":"微商刷单诈骗","victim":"侯桂花","amount":45600,"type":"刷单返利","desc":"在朋友圈看到微商招刷手广告，添加后按要求下单但不付款，直接转账到对方微信。前两单返利后信任对方，第三单转账后对方拉黑。"},
                {"title":"刷单赚佣金诈骗","victim":"龙建军","amount":92300,"type":"刷单返利","desc":"收到兼职短信称刷单赚佣金日入300元，添加QQ后被拉入任务群。完成小单后获得佣金15元，后被引导做预付任务，通过手机银行转账后无法联系客服。"},
                {"title":"基金投资诈骗","victim":"倪桂花","amount":345000,"type":"投资理财","desc":"在抖音看到基金投资广告，添加对方微信后被拉入投资群。群内老师推荐购买某私募基金产品，声称年化收益35%。转账后收到电子合同，三个月后发现平台失联。"},
                {"title":"虚拟货币投资诈骗","victim":"彭丽娟","amount":234000,"type":"投资理财","desc":"通过婚恋网站认识对象，对方称有虚拟货币内幕消息。引导在某平台投资USDT，前期盈利后期无法提现。"},
                {"title":"冒充公司老板诈骗财务","victim":"张敏","amount":650000,"type":"冒充熟人","desc":"公司财务接到冒充老板的QQ消息，称急需支付一笔合同款。因头像和昵称一致未核实，通过公司对公账户转账。"},
                {"title":"冒充公安社保诈骗","victim":"汤美玲","amount":278000,"type":"冒充公检法","desc":"接到冒充上海社保局电话，称其社保卡在上海异地报销涉嫌骗保。转接冒充公安的电话后，被要求缴纳取保候审保证金。"},
                {"title":"冒充经侦资金核查诈骗","victim":"雷玉华","amount":198000,"type":"冒充公检法","desc":"接到冒充经济侦查支队民警电话，称其银行卡被犯罪团伙利用需进行资金核查。要求将所有存款集中到一张卡并告知短信验证码，资金随即被转走。"},
                ...
                {"title":"冒充国安调查诈骗","victim":"康建军","amount":567000,"type":"冒充公检法","desc":"接到冒充国家安全部门电话，称其涉嫌泄露国家机密需配合调查。要求购买新手机并保持通话不中断，诱导在多个网贷平台借款后转账到安全账户。"},
                ...
                {"title":"冒充淘宝客服退货诈骗","victim":"潘美玲","amount":156700,"type":"冒充客服","desc":"接到冒充淘宝客服电话，称其购买的护肤品有质量问题可退一赔三。诱导下载钉钉开启屏幕共享，以退款需要资金验证为由骗取转账。"},
                ...
                {"title":"刷单垫付诈骗","victim":"陈国平","amount":67800,"type":"刷单返利","desc":"在兼职猫平台看到垫付刷单招聘，添加对方微信后开始做任务。垫付第一单返利后连续垫付多单，对方失联。"},
                {"title":"刷单连环任务诈骗","victim":"姜丽娟","amount":156000,"type":"刷单返利","desc":"在豆瓣看到兼职招聘信息，添加对方QQ后下载飞聊APP。被分配连环任务需完成多单才能结算，每单垫付金额递增，完成后平台提示系统维护无法提现。"},
                ...
                {"title":"冒充亲戚借钱诈骗","victim":"蔡丽娟","amount":125000,"type":"冒充熟人","desc":"接到冒充在外地做生意的亲属的电话，称急需资金周转。声音相似未起疑心，转账后联系本人发现被骗。"},
                {"title":"冒充熟人代购诈骗","victim":"丁建军","amount":67800,"type":"冒充熟人","desc":"收到冒充朋友的私信，称急需帮忙代购物品。转账后联系朋友发现账号被盗。"},
                ...
                {"title":"冒充电信客服升级套餐","victim":"唐玉华","amount":28600,"type":"冒充客服","desc":"接到冒充中国电信客服电话，称可免费升级5G套餐。要求提供身份证号登记，后银行卡被盗刷。"},
                {"title":"冒充京东微信修复诈骗","victim":"刘洋","amount":178900,"type":"冒充客服","desc":"冒充京东客服以微信修复为由，诱导受害人下载指定APP并开启屏幕共享。共骗取受害人通过银行转账和网贷借款方式转出资金。"},
            ]
    ...
    try:
        ...
        existing_flow_count = db.session.query(CapitalFlow).count()
